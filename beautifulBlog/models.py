...
class user(models.Model):
    ...
    icon1 = models.ImageField(u'主页图片1', upload_to="files/userImage", default="", blank=True)
    icon2 = models.ImageField(u'主页图片2', upload_to="files/userImage", default="", blank=True)
    icon3 = models.ImageField(u'主页图片3', upload_to="files/userImage", default="", blank=True)
